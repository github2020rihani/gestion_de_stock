...
class FournisseurController extends AbstractController
{
    ...
    /**
     * @Route("/new", name="achat_add_fournisseur")
     */
    ...
    /**
     * @Route("/", name="achat_index_fournisseur")
     */
    ...
    /**
     * @Route("/{id<\d+>}", name="achat_delete_fournisseur")
     */
    ...
    /**
     * @Route("/edit/{id<\d+>}", name="achat_edit_fournisseur")
     */
