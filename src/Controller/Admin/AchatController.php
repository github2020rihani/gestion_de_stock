...
class AchatController extends AbstractController
{
     ...
     * @Route("/add", name="achat_add_achat")
     */
    public function new(Request $request)
    {
        ...
        return $this->render('admin/Achat/new.html.twig', ['article' => '',
            'fournisseurs' => $fournisseurs,
            'articles' => $articles,]);
    }

    /**
     * @Route("/", name="achat_index_achat")
     */
    public
    ...
    /**
     * @Route("/edit/{id}", name="achat_edit_achat")
     */
    public
    ...
    /**
     * @Route("/detail/{id}", name="achat_detail_achat")
     */
    public
    function detail(Achat $achat, Request $request): Response
    {
        ...
        return $this->render('admin/Achat/detail.html.twig', [
            'fournisseurs' => $fournisseurs,
            'articles' => $articles,
            'achat' => $achatObjet[0],
        ]);
    ...
    /**
     * @param Request $request
     * @Route("/get/articles", name="achat_get_articles", options={"expose" = true})
     */
    public
    ...
    /**
     * @param Request $request
     * @Route("/get/articlesById", name="achat_get_articles_byId", options={"expose" = true})
     */
    public
     ...
     * @Route("/get/articles/achat", name="achat_get_articles_achat", options={"expose" = true})
     */
    public
