...
class InventaireController extends AbstractController
{
    ...
    /**
     * @Route("/", name="achat_index_inventaire")
     */
     ...
     * @Route("/select/inventaire", name="achat_get_inventaire", options={"expose" =true})
     */
                                  ...
                                  PaginatorInterface $paginator)
    {
        ...
        if ($inventaire) {
            ...
            $dataInv = $paginator->paginate(
                ...
                $status = 'true';
            $content = $this->render('admin/inventaire/_contentInventaire.html.twig', array(
                'inv' => $dataInv
    ...
    /**
     * @Route("/imprime/inventaire", name="achat_imprime_inventaire", options={"expose" =true})
     */
    public function ImprimerInvetaire()
    {
        ...
        if ($lastInventaire){
            ...
            $html = $this->renderView('admin/inventaire/print_inventaire.html.twig', [
                'inv' => $dataInv[0]
            ]);
    ...
    /**
     * @Route("/excel/inventaire", name="achat_download_excel_inventaire", options={"expose" =true})
     */
