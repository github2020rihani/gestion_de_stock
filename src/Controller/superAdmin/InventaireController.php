...
class InventaireController extends AbstractController
{
                          ...
                          InventaireArticleRepository $inventaireArticleRepository)
    {
        ...
        if ($invtaires) {
            ...
            return $this->render('superAdmin/inventaire/index.html.twig',
                                  ...
                                  PaginatorInterface $paginator)
    {
        ...
        if ($inventaire) {
            ...
            $status = 'true';
            $content = $this->render('superAdmin/inventaire/_contentInventaire.html.twig', array(
                'inv' => $dataInv
    ...
    /**
     * @Route("/imprime/inventaire", name="imprime_inventaire", options={"expose" =true})
     */
    public function ImprimerInvetaire()
    {
        ...
        if ($lastInventaire){
            ...
            $html = $this->renderView('superAdmin/inventaire/print_inventaire.html.twig', [
                'inv' => $dataInv[0]
            ]);
    ...
    /**
     * @Route("/excel/inventaire", name="download_excel_inventaire", options={"expose" =true})
     */
