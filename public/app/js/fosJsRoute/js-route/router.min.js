!function (e, t) {
    var n = t();
    "function" == typeof define && define.amd ? define([], n.Routing) : "object" == typeof module && module.exports ? module.exports = n.Routing : (e.Routing = n.Routing, e.fos = {Router: n.Router})
}(this, function () {
    "use strict";
    ...
    var t = Object.assign || function (e) {
        ...
        return o(i, [{
            key: "setRoutingData", value: function (e) {
            ...
            key: "setRoutes", value: function (e) {
                this.routes_ = Object.freeze(e)
            }
        }, {
            key: "getRoutes", value: function () {
                return this.routes_
            }
        }, {
            ...
            key: "getScheme", value: function () {
                return this.context_.scheme
            }
        }, {
            key: "setHost", value: function (e) {
            ...
            key: "setPort", value: function (e) {
                this.context_.port = e
            }
        }, {
            key: "getPort", value: function () {
            ...
            key: "buildQueryParams", value: function (e, t, o) {
                var i = this, r = void 0, s = new RegExp(/\[\]$/);
                ...
                }); else if ("object" === ("undefined" == typeof t ? "undefined" : n(t))) for (r in t) this.buildQueryParams(e + "[" + r + "]", t[r], o); else o(e, t)
            }
        }, {
            key: "getRoute", value: function (e) {
                var t = this.context_.prefix + e, n = e + "." + this.context_.locale,
                    o = this.context_.prefix + e + "." + this.context_.locale, i = [t, n, o, e];
                for (var r in i) if (i[r] in this.routes_) return this.routes_[i[r]];
                throw new Error('The route "' + e + '" does not exist.')
            }
        }, {
            key: "generate", value: function (e, n) {
                var o = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = this.getRoute(e),
                    r = n || {}, s = t({}, r), u = "", c = !0, a = "",
